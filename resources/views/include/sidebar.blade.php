<div class="app-sidebar colored">
    <div class="sidebar-header">
        <a class="header-brand" href="{{route('dashboard')}}">
            <div class="logo-img">
               <img height="30" src="{{ asset('img/logo-ssi-white.png')}}" class="header-brand-img" title="Localhost"> 
            </div>
        </a>
    ...
    <div class="sidebar-content">
        <div class="nav-container">
            <nav id="main-menu-navigation" class="navigation-main">
                ...
                <div class="nav-item {{ ($segment1 == 'reports') ? 'active' : '' }}" style="display:none;">
                    <a href="{{route('dashboard')}}"><i class="ik ik-pie-chart"></i><span>{{ __('Reports')}}</span></a>
                </div>
