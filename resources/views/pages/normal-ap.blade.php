                ...
                <div class="col-xl-5 col-lg-12 col-md-6 col-sm-12 col-12 layout-spacing">
                    <div class="widget-content widget-content-area br-6">
                        <div class="widget-heading">
                            <h5 class="">Normal Ap's</h5>
                        </div>
                        <div class="my-3 d-flex justify-content-center">
                            <form action="/normal-ap/search" method="GET">
                                ...
                                <div class="">
                                    <div class="d-flex align-items-center">
                                        <div class="bg-secondary p-2 rounded-circle " style="height: max-content;">
                                            <div class="icon">
                                                @if ($n->attackmode == "suspect")
                                                <i data-feather="alert-triangle" class="text-lg"></i>
                                                @elseif ($n->attackmode == "eviltwin")
                                                <i data-feather="x" class="text-lg"></i>
                                                @elseif ($n->attackmode == "cracking")
                                                <i data-feather="x" class="text-lg"></i>
                                                @else
                                    ...
                                    <div class="t-rate rate-dec d-flex justify-content-end">
                                        <a href="wifi/inspect/{{$n->id}} " class="text-primary">Detail</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pt-3 d-flex justify-content-center">
                            {{ $normal_ap->links('pagination::simple-bootstrap-4') }}
                        </div>
                    </div>
                </div>
